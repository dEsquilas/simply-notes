...
<template>
    <div>
        <div class="min-h-screen bg-cblack flex flex-col text-white">
            <nav class="bg-cblack border-cgray border-b">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('notebooks.index')" :active="route().current('notebooks.index')">
                                    Notebooks
                                </NavLink>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('notebooks.index')" :active="route().current('notebooks.index')">
                            Notebooks
                        </ResponsiveNavLink>
                    </div>
            ...
            <main class="flex-grow flex flex-col">
                <div class="min-h-full flex-grow flex">
                    <slot />
                </div>
            </main>
        </div>
