...
">
            <nav class="border-cgray border-b">
                <!-- Primary Navigation Menu -->
                <div class="mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            <!-- Logo -->
                            <div class="shrink-0 flex items-center w-[300px]">
                                <Link :href="'/'">
                                    ...
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                data-test="user-menu"
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-white bg-main1 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-hidden transition ease-in-out duration-150"
                                            >
                        ...
                        <div class="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-200 hover:bg-main1 focus:outline-hidden focus:bg-main1 focus:text-gray-200 transition duration-150 ease-in-out"
                            >
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t border-cgray">
                        <div class="px-4">
            ...
            <main class="grow flex flex-col">
                <div class="min-h-full grow flex">
                    <slot />
                </div>
            </main>
        </div>
